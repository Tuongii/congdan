...
const LOAI_YEU_CAU_LABELS: Record<string, { label: string; color: string }> = {
  ...
  xac_nhan_cong_tac: { label: "💂 Tuyển quân", color: "bg-blue-50 text-blue-700 border-blue-200" },
...
export default function QuanTriPage() {
  ...
  const handleExportExcel = () => {
    ...
    const LOAI_YEU_CAU_MAP: Record<string, string> = {
      ...
      che_do_chinh_sach: "Giải quyết chế độ chính sách",
      xac_nhan_cong_tac: "Tư vấn tuyển quân, tuyển sinh",
